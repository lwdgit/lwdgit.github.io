...
*/
(function(){var e=Cache.prototype.addAll;var t=navigator.userAgent.match(/(Firefox|Chrome)\/(\d+\.)/);if(t){var r=t[1];var n=parseInt(t[2])}if(e&&(!t||r==="Firefox"&&n>=46||r==="Chrome"&&n>=50)){return}Cache.prototype.addAll=function o(e){var t=this;function r(e){this.name="NetworkError";this.code=19;this.message=e}r.prototype=Object.create(Error.prototype);return Promise.resolve().then(function(){if(arguments.length<1)throw new TypeError;var t=[];e=e.map(function(e){if(e instanceof Request){return e}else{return String(e)}});return Promise.all(e.map(function(e){if(typeof e==="string"){e=new Request(e)}var t=new URL(e.url).protocol;if(t!=="http:"&&t!=="https:"){throw new r("Invalid scheme")}return fetch(e.clone())}))}).then(function(n){if(n.some(function(e){return!e.ok})){throw new r("Incorrect response status")}return Promise.all(n.map(function(r,n){return t.put(e[n],r)}))}).then(function(){return undefined})};Cache.prototype.add=function i(e){return this.addAll([e])}})();
